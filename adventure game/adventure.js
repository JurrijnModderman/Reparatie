...
function Start() {
	...
	container.style.backgroundImage = 'url(' + imageMap + '/Wie_moet_ik_hebben.jpg)';
...
function einde() {
	...
	description.innerHTML = 'Je hebt gewonnen!!!' + '<br>' + 'Wil je nog een keer spelen? Klik dan op Start!';
